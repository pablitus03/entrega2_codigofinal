...
st.write("""
"Ingresa el diminutivo coorespondiente al idioma al que quieres traducir. Si no te lo sabes, aquí te doy un ejemplo de los más conocidos:  -Inglés (en) -Hindi (hi) -Árabe (ar) -Bengalí (bn) -Portugués (pt) -Ruso (ru) -Japonés (ja):""")
